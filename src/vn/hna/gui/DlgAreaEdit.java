 ...
 * @author Edison
 */
public class DlgAreaEdit extends javax.swing.JDialog {
    FrmMain frmMain = null;
    PnlArea pnlRole = null;
    Vector<Areas> v = null;
    int idx = 0;
     ...
     */
    public DlgAreaEdit(FrmMain parent, boolean modal) {
        super(parent, modal);
        frmMain = parent;
        initComponents();
...
//    }
    ...
    public void loadData(Vector<Areas> v) {
        try {
            if (v.isEmpty()) {
            ...
            Areas area = v.get(idx);
            txtID.setText(new Integer(area.getAreaID()).toString());
