...
import static vn.hna.gui.PnlRole.selectedRow;
...
public class PnlUser extends javax.swing.JPanel {
    ...
    Vector<Users> vAll = null; // Load tu SQLServer
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        ...
        DlgUserAdd dlg = new DlgUserAdd(frmMain, true);
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        ...
        try {
                ...
                role.setUserID(Integer.parseInt(vRow.get(0).toString()));
                int id = role.getUserID();
    ...
    public Vector loadColumnHeader() {
        ...
        try {
            vColumnHeader.add("User ID");
            vColumnHeader.add("Username");
            vColumnHeader.add("Full Name");
            vColumnHeader.add("Role");
            vColumnHeader.add("Rank");
    ...
    public List loadData(List<Users> listAll) {
        try {
            if (listAll.isEmpty()) {
                JOptionPane.showMessageDialog(this, "No data.", "Information", JOptionPane.INFORMATION_MESSAGE);
            }
            ...
            vData = new Vector();
            for (Users entity : listAll) {
                Vector vRow = new Vector();

                vRow.add(entity.getUserID());
                vRow.add(entity.getUsername());
                vRow.add(entity.getFullName());
                vRow.add(entity.getRoleID().getRoleName());
                vRow.add(entity.getRank());
    ...
    public Vector searchByRoleName(Vector<Users> v, String byName) {
        Vector<Users> vFilter = new Vector();
        try {
            for (Users entity : v) {
                if (entity.getFullName().toUpperCase().contains(byName.toUpperCase())) {
                    vFilter.add(entity);
                }
            }
        } catch (Exception e) {
