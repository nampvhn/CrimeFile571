 ...
 * @author Edison
 */
public class PnlVictim extends javax.swing.JPanel {

    Vector vColumnHeader = null;
    Vector vData = null; // Lay tu vAll
    Vector<Victims> vAll = null; // Load tu SQLServer
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        ...
        try {
            ...
            Victims criminal = new Victims();
            criminal.setVictimID(Integer.parseInt(vRow.get(0).toString()));
            int id = criminal.getVictimID();
    ...
    public Vector loadColumnHeader() {
        ...
        try {
            vColumnHeader.add("Victim ID");
            vColumnHeader.add("Full Name");
            vColumnHeader.add("Birthday");
            vColumnHeader.add("Is Death?");
            vColumnHeader.add("Relative Name");
        } catch (Exception e) {
            e.printStackTrace();
            return null;
        }
    ...
    public void loadTable() {
        ...
        try {
            ...
            vAll = (Vector<Victims>) c.viewCriminals();
            if (vAll.isEmpty()) {
    ...
    public List loadData(List<Victims> listAll) {
        ...
        try {
            ...
            vData = new Vector();
            for (Victims criminal : listAll) {
                Vector vRow = new Vector();

                vRow.add(criminal.getVictimID());
                vRow.add(criminal.getFullName());
                vRow.add(dt.formatedDate(criminal.getBirthday(), "yyyy-MM-dd"));
                if (criminal.getIsDead()== true) {
                    vRow.add("Yes");
                } else {
                    vRow.add("No");
                }
                vRow.add(criminal.getRelativeName());
    ...
    public Vector searchByName(Vector<Victims> v, String byName) {
        Vector<Victims> vFilter = new Vector();
        try {
            for (Victims criminal : v) {
