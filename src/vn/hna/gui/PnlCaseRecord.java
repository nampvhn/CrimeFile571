...
import vn.hna.db.CaseCriminalDB;
import vn.hna.db.CaseRecordsDB;
 ...
 * @author Edison
 */
public class PnlCaseRecord extends javax.swing.JPanel {

    Vector vColumnHeader = null;
    Vector vData = null; // Lay tu vAll
    Vector<CaseCriminal> vAll = null; // Load tu SQLServer
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        CaseRecordsDB db = new CaseRecordsDB();
        try {
            ...
            CaseRecords entity = new CaseRecords();
            entity.setCrID(Integer.parseInt(vRow.get(0).toString()));
            int id = entity.getCrID();
    ...
    private void btnSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSearchActionPerformed
        Vector<CaseCriminal> vFilter = null;
        try {
    ...
    public Vector loadColumnHeader() {
        ...
        try {
            vColumnHeader.add("Case Record ID");
            vColumnHeader.add("Case Record Name");
            vColumnHeader.add("Date of Incident");
            vColumnHeader.add("Criminal");
    ...
    public void loadTable() {
        CaseCriminalDB db = new CaseCriminalDB();
        try {
            tblModel = (DefaultTableModel) tbl.getModel();
            vAll = (Vector<CaseCriminal>) db.viewCaseCriminal();
            if (vAll.isEmpty()) {
    ...
    public List loadData(List<CaseCriminal> listAll) {
        ...
        try {
            ...
            vData = new Vector();
            for (CaseCriminal entity : listAll) {
                Vector vRow = new Vector();

                vRow.add(entity.getCcID());
                vRow.add(entity.getCrID().getCrName());
                vRow.add(dt.formatedDate(entity.getCrID().getDateOfIncident(), "yyyy-MM-dd hh:mm"));
                vRow.add(entity.getCriminalID().getFullName());
                vRow.add(entity.getCrID().getUserID().getFullName());
    ...
    public Vector searchByName(Vector<CaseCriminal> v, String byName) {
        Vector<CaseCriminal> vFilter = new Vector();
        try {
            for (CaseCriminal entity : v) {
                if (entity.getCriminalID().getFullName().toUpperCase().contains(byName.toUpperCase())) {
                    vFilter.add(entity);
                }
            }
        } catch (Exception e) {
