 ...
 * @author Edison
 */
public class PnlCrimeType extends javax.swing.JPanel {

    Vector vColumnHeader = null;
    Vector vData = null; // Lay tu vAll
    Vector<CrimeTypes> vAll = null; // Load tu SQLServer
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        ...
        DlgCrimeTypeAdd dlg = new DlgCrimeTypeAdd(frmMain, true);
    ...
    private void btnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditActionPerformed
        try {
            ...
            DlgCrimeTypeEdit editDialog = new DlgCrimeTypeEdit(frmMain, true);
            this.setVisible(false);
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        ...
        try {
                ...
                crimeType.setCrimeTypeID(Integer.parseInt(vRow.get(0).toString()));
                int id = crimeType.getCrimeTypeID();
    ...
    private void btnSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSearchActionPerformed
        Vector<CrimeTypes> vFilter = null;
        try {
            vFilter = this.searchByCrimeTypeName(vAll, txtSearch.getText().trim());
            if (vFilter == null) {
    ...
    public void loadTable() {
        ...
        try {
            ...
            vAll = (Vector<CrimeTypes>) ct.viewCrimeTypes();
            if (vAll.isEmpty()) {
    ...
    public List loadData(List<CrimeTypes> listAll) {
        try {
            if (listAll.isEmpty()) {
                JOptionPane.showMessageDialog(this, "No data.", "Information", JOptionPane.INFORMATION_MESSAGE);
            }
            ...
            vData = new Vector();
            for (CrimeTypes crimeType : listAll) {
                Vector vRow = new Vector();

                vRow.add(crimeType.getCrimeTypeID());
                vRow.add(crimeType.getCrimeTypeName());
    ...
    public Vector searchByCrimeTypeName(Vector<CrimeTypes> v, String byName) {
        Vector<CrimeTypes> vFilter = new Vector();
        try {
            for (CrimeTypes crimeType : v) {
                if (crimeType.getCrimeTypeName().toUpperCase().contains(byName.toUpperCase())) {
