 ...
 * @author Edison
 */
public class DlgComplaintTypeAdd extends javax.swing.JDialog {
    FrmMain frmMain = null;

    /**
     * Creates new form DlgRoleAdd
     */
    public DlgComplaintTypeAdd(FrmMain parent, boolean modal) {
        super(parent, modal);
        frmMain = parent;
    ...
    private void initComponents() {
        ...
        lblCrimeTypeName.setText("Complaint Type Name: ");
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        ...
        try {
            ...
            if (ct.insert(crimeTypeName, desc)) {
                ...
                PnlComplaintType pnl = new PnlComplaintType();
                this.dispose();
                pnl.setVisible(true);
