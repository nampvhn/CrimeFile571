 ...
 * @author Edison
 */
public class PnlPrison extends javax.swing.JPanel {

    Vector vColumnHeader = null;
    Vector vData = null; // Lay tu vAll
    Vector<Prisons> vAll = null; // Load tu SQLServer
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        ...
        try {
                ...
                Prisons role = new Prisons();
                role.setPrisonID(Integer.parseInt(vRow.get(0).toString()));
                int id = role.getPrisonID();
    ...
    public Vector loadColumnHeader() {
        ...
        try {
            ...
            vColumnHeader.add("Prison Name");
            vColumnHeader.add("Address");
        } catch (Exception e) {
            e.printStackTrace();
            return null;
        }
    ...
    public void loadTable() {
        ...
        try {
            ...
            vAll = (Vector<Prisons>) r.viewPrisons();
            if (vAll.isEmpty()) {
    ...
    public List loadData(List<Prisons> listAll) {
        try {
            if (listAll.isEmpty()) {
                JOptionPane.showMessageDialog(this, "No data.", "Information", JOptionPane.INFORMATION_MESSAGE);
            }
            ...
            vData = new Vector();
            for (Prisons role : listAll) {
                Vector vRow = new Vector();

                vRow.add(role.getPrisonID());
                vRow.add(role.getPrisonName());
                vRow.add(role.getAddress());
    ...
    public Vector searchByRoleName(Vector<Prisons> v, String byName) {
        Vector<Prisons> vFilter = new Vector();
        try {
            for (Prisons role : v) {
                if (role.getPrisonName().toUpperCase().contains(byName.toUpperCase())) {
                    vFilter.add(role);
                }
            }
        } catch (Exception e) {
