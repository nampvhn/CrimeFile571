 ...
 * @author Edison
 */
public class DlgComplaintTypeEdit extends javax.swing.JDialog {
    FrmMain frmMain = null;
    PnlComplaintType pnlRole = null;
    Vector<ComplaintTypes> v = null;
    int idx = 0;

    /**
     * Creates new form DlgRoleEdit
     */
    public DlgComplaintTypeEdit(FrmMain parent, boolean modal) {
        super(parent, modal);
        frmMain = parent;
        initComponents();
    ...
    private void initComponents() {
        ...
        lblRoleName.setText("Complaint Type:");
...
//    }
    ...
    public void loadData(Vector<ComplaintTypes> v) {
        try {
            if (v.isEmpty()) {
            ...
            ComplaintTypes role = v.get(idx);
            txtID.setText(new Integer(role.getCplTypeID()).toString());
            txtName.setText(role.getCplTypeName());
    ...
    public Vector loadDataFromSQLServer() {
        ComplaintTypesDB r = new ComplaintTypesDB();
        try {
            return (Vector) r.viewComplaintTypes();
        } catch (Exception e) {
            e.printStackTrace();
            return null;
        }
