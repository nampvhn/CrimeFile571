 ...
 * @author Edison
 */
public class PnlComplainant extends javax.swing.JPanel {

    Vector vColumnHeader = null;
    Vector vData = null; // Lay tu vAll
    Vector<Complainants> vAll = null; // Load tu SQLServer
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        ...
        try {
            ...
            Complainants criminal = new Complainants();
            criminal.setCplnID(Integer.parseInt(vRow.get(0).toString()));
            int id = criminal.getCplnID();
    ...
    private void btnSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSearchActionPerformed
        Vector<Complainants> vFilter = null;
        try {
    ...
    public Vector loadColumnHeader() {
        ...
        try {
            ...
            vColumnHeader.add("ID Card");
            vColumnHeader.add("Passport No");
    ...
    public void loadTable() {
        ...
        try {
            ...
            vAll = (Vector<Complainants>) c.viewCplns();
            if (vAll.isEmpty()) {
    ...
    public List loadData(List<Complainants> listAll) {
        ...
        try {
            ...
            vData = new Vector();
            for (Complainants criminal : listAll) {
                Vector vRow = new Vector();

                vRow.add(criminal.getCplnID());
                vRow.add(criminal.getFullName());
                
                vRow.add(criminal.getIdentityCard());
                vRow.add(criminal.getPassportNo());
...
//                vRow.add(crimeList);
    ...
    public Vector searchByName(Vector<Complainants> v, String byName) {
        Vector<Complainants> vFilter = new Vector();
        try {
            for (Complainants criminal : v) {
