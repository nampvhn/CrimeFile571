 ...
 * @author Edison
 */
public class PnlFIR extends javax.swing.JPanel {

    Vector vColumnHeader = null;
    Vector vData = null; // Lay tu vAll
    Vector<FIRs> vAll = null; // Load tu SQLServer
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        ...
        try {
            ...
            FIRs entity = new FIRs();
            entity.setFirID(Integer.parseInt(vRow.get(0).toString()));
            int id = entity.getFirID();

            int choose = JOptionPane.showConfirmDialog(this, "Are you sure to delete this? Y/N?", "Comfirm", JOptionPane.YES_NO_OPTION);
            if (choose == JOptionPane.YES_OPTION) {
                boolean del = f.delete(id);
                if (del) {
    ...
    public List loadData(List<FIRs> listAll) {
        ...
        try {
            ...
            vData = new Vector();
            for (FIRs entity : listAll) {
                Vector vRow = new Vector();

                vRow.add(entity.getFirID());
                vRow.add(dt.formatedDate(entity.getDateOfIncident(), "yyyy-MM-dd hh:mm"));
    ...
    public Vector searchByName(Vector<FIRs> v, String byName) {
        Vector<FIRs> vFilter = new Vector();
        try {
            for (FIRs entity : v) {
